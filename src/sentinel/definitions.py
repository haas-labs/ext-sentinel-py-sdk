...
BLOCKCHAIN = {
    ...
    "linea": Blockchain(
        network="linea", chain_id=59144, short_name="linea", description="Linea", currency="ETH"
    ),
    "polygon": Blockchain(
        network="polygon", chain_id=137, short_name="polygon", description="Polygon Mainnet", currency="MATIC"
    ),
    "blast": Blockchain(
        network="blast", chain_id=238, short_name="blast", description="Blast Mainnet", currency="ETH"
    ),
    "zksync": Blockchain(
        network="zksync", chain_id=324, short_name="zksync", description="zkSync Mainnet", currency="ETH"
    ),
    "scroll": Blockchain(
        network="scroll", chain_id=534352, short_name="scroll", description="Scroll", currency="ETH"
    ),
