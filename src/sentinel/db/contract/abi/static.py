...
from sentinel.models.contract import ABIInput, ABIRecord, ABISignature
...
ABI_EVENT_OWNERSHIP_TRANSFERED = ABISignature(
    ...
    abi=ABIRecord(
        ...
        type="event",
        inputs=[
            ABIInput(internal_type="address", name="previousOwner", type="address", indexed=True),
            ABIInput(internal_type="address", name="newOwner", type="address", indexed=True),
        ],
        outputs=[],
...
ABI_EVENT_WITHDRAWAL = ABISignature(
    ...
    abi=ABIRecord(
        ...
        type="event",
        inputs=[
            ABIInput(internal_type="address", name="to", type="address", indexed=False),
            ABIInput(internal_type="bytes32", name="nullifierHash", type="bytes32", indexed=False),
            ABIInput(internal_type="address", name="relayer", type="address", indexed=True),
            ABIInput(internal_type="uint256", name="fee", type="uint256", indexed=False),
        ],
        outputs=[],
        state_mutability=None,
        payable=None,
...
ABI_EVENT_TRANSFER = ABISignature(
    ...
    abi=ABIRecord(
        ...
        type="event",
        inputs=[
            ABIInput(internal_type=None, name="from", type="address", indexed=True),
            ABIInput(internal_type=None, name="to", type="address", indexed=True),
            ABIInput(internal_type=None, name="value", type="uint256", indexed=False),
        ],
        outputs=[],
        state_mutability=None,
        payable=None,
