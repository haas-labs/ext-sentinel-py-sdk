...
def test_metric_core_database_update():
    db = MetricDatabase()
    db.update(use_current_time(SAMPLE_ENUM_METRIC))
    db.update(use_current_time(SAMPLE_INFO_METRIC))
    db.update(use_current_time(SAMPLE_COUNTER_METRIC))
    db.update(use_current_time(SAMPLE_GAUGE_METRIC))
    db.update(use_current_time(SAMPLE_SUMMARY_METRIC))
    db.update(use_current_time(SAMPLE_HISTOGRAM_METRIC))
...
def test_metric_core_database_clean():
    ...
    db.update(SAMPLE_COUNTER_METRIC)
